...
class AppColors {
  ...
  static const bgTaskCardIncomplete = Color(0xFFFFFFFF);
  static const bgTaskCardComplete = Color(0xFFE6E6E6);
  static const bgBottomBar = Color(0xFFE0E0E0);
  static const bgFabDark = Color(0xFF999999);
  static const bgFabLight = Color(0xFFBFBFBF);
  static const timeText = Color(0xFF808080);
  static const taskText = Color(0xFF0D0D0D);
  static const secondaryText = Color(0xFFa6a6a6);
